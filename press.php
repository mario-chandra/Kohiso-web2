    ...
    <div class="press">
        <div class="container press">
            ...
            <div class="press-item">
                <div class="press-img">
                    <img src="asset/img/press.jpg" class="press-img">
                    <div class="press-overlay">
                    </div>
                </div>
                <div class="press-main">
                    <h1 class="press-main">Analisa</h1>
                    <div class="text-center" style="display: none">
                        <h3>Medan Grand Opening</h3>
                        <a href="https://analisadaily.com/" class="btn kohiso-btn">See more</a>
                    </div>
                </div>
            </div>
